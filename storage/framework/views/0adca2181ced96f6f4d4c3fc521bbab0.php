                ...
                <div class="relative flex flex-col justify-center px-12 lg:px-16 w-full">
                    ...
                    <div class="mt-16 grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-sm text-primary-200 mt-1"><?php echo e(__('app.trips_completed')); ?></p>
                        </div>
                        <div>
                            <p class="text-3xl font-extrabold text-white">50+</p>
                            <p class="text-sm text-primary-200 mt-1"><?php echo e(__('app.cities_covered')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\Hi\OneDrive\Documents\GoRide\go_ride\resources\views/layouts/guest.blade.php ENDPATH**/ ?>