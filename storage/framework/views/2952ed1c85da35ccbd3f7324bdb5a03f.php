...
<?php $component->withAttributes([]); ?>
    <div class="mb-8">
        <h2 class="text-2xl font-extrabold text-slate-900"><?php echo e(__('app.register_title')); ?></h2>
        <p class="mt-2 text-sm text-slate-500"><?php echo e(__('app.register_subtitle')); ?></p>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5">
        ...
        <!-- Full Name -->
        <div>
            <label for="name" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('app.full_name')); ?></label>
            <input id="name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name"
                   ...
                   placeholder="<?php echo e(__('app.name_placeholder')); ?>">
        </div>
        ...
        <!-- Phone Number -->
        <div>
            <label for="phone" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('app.phone')); ?></label>
            <div class="flex">
                ...
                <input id="phone" type="tel" name="phone" :value="old('phone')" required autocomplete="tel"
                       ...
                       placeholder="<?php echo e(__('app.phone_placeholder')); ?>"
                       pattern="[0-9]{10}" maxlength="10">
            </div>
            <p class="mt-1.5 text-xs text-slate-400"><?php echo e(__('app.phone_hint')); ?></p>
        </div>
        ...
        <!-- Confirm Password -->
        <div x-data="{ show: false }">
            <label for="password_confirmation" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('app.confirm_password')); ?></label>
            <div class="relative">
                <input id="password_confirmation" :type="show ? 'text' : 'password'" name="password_confirmation" required autocomplete="new-password"
                       class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm px-4 py-3 pr-12"
                       placeholder="<?php echo e(__('app.confirm_password_placeholder')); ?>">
                <button type="button" @click="show = !show"
                        class="absolute inset-y-0 right-0 flex items-center pr-4 text-slate-400 hover:text-slate-600 transition">
                    <svg x-show="!show" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
    ...
    <div class="mt-8 text-center">
        <p class="text-sm text-slate-500">
            <?php echo e(__('app.has_account')); ?>

            <a href="<?php echo e(route('login')); ?>" class="font-semibold text-primary-600 hover:text-primary-700 transition">
                <?php echo e(__('app.sign_in_link')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Hi\OneDrive\Documents\GoRide\go_ride\resources\views\auth\register.blade.php ENDPATH**/ ?>