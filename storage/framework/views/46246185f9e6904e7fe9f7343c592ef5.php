...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="h-full">
    <head>
        ...
        <title><?php echo e(config('app.name', 'GoRide')); ?> - Register</title>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <p class="mt-6 text-center text-sm text-gray-600">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="font-semibold text-primary-600 hover:text-primary-500">Sign in</a>
                    </p>
                </div>
            </div>
        </div>
